...
export class ApiClient {
    ...
    constructor (private baseUrl: string, private headers?: PlexHeaders) {
    ...
    delete<T> (endpoint: string, params?: object, headers?: PlexHeaders): Promise<T> {
        return this.request<T>(
    ...
    post<T> (endpoint: string, body?: object, params?: object, headers?: PlexHeaders): Promise<T> {
        return this.request<T>(
    ...
    put<T> (endpoint: string, body?: object, params?: object, headers?: PlexHeaders): Promise<T> {
        return this.request<T>(
